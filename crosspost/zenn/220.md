...
emoji: "🛠️"
type: "tech"
topics: ["claude", "claudecode", "ai", "個人開発", "oss"]
published: false
---

> この記事は、自分のサイト [Y.NetLabo](https://ynetlabo.net) に書いたものの再掲です。
> 原文: https://ynetlabo.net/archives/220
...
- サイト内の一覧：[Claude スキル集](https://ynetlabo.net/skills)
...
`exam-prep` は[前回の記事](https://ynetlabo.net/archives/219)で書いた、試験前日にやった学習ループをそのままスキルにしたものだ。
...
各スキルの `SKILL.md` は全文を[スキル一覧ページ](https://ynetlabo.net/skills)に載せてあるので、入れる前に中身を読んでから判断できる。

スキルは今後も増やしていく予定です。要望や「ここが動かない」があれば、[お問い合わせ](https://ynetlabo.net/contact)か GitHub の Issue からお願いします。

---

個人開発でつくったアプリと、その裏側を [Y.NetLabo](https://ynetlabo.net) に書いています。
この記事の原文はこちら: https://ynetlabo.net/archives/220
